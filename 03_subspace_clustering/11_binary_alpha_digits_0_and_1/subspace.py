...
def subspace_clustering(set_gamma=0.001,
    ...
    problem = '../../06_datasets/01_binary_alpha_digits/02_binary_alpha_digits_0_and_1_78.ds'
    ground_truth = '../../06_datasets/01_binary_alpha_digits/02_binary_alpha_digits_0_and_1_78_ground_truth.ds'
