...
def k_means(problem, ground_truth, printer=False, plotter=False, save_figure=False, axis_hold=False):
...
if __name__ == '__main__':
    ...
    save_figure = False
    axis_hold = False
    k_means('../05_toy_problems/01_simple_two_and_two.tp',
            '../05_toy_problems/01_simple_two_and_two_ground_truth.tp',
            printer, plotter, save_figure, axis_hold)