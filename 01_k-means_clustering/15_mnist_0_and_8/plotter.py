...
def plotter(Y, kmeans_labels, nmi, prob_type, prob_title, printer=False, save_figure=False, axis_hold=False):
    '''
    ...
    text = '../07_figures/01_k-means_clustering/' + prob_type + '_solve_' + prob_title.replace("../05_", '').replace("s/", '_').replace(".", '_') + '.png'
